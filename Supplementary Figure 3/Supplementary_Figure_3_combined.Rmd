...
This R Markdown combines the R scripts under `scripts/Supplementary Figure 3` into one document. Each script is included as a separate R code chunk (full original contents).
...
organ_color <- c("blood" = "#9f81b8","bone"= "#e8c0ba","colon"= "#f7b6d1","cortex"= "#855aa5","fat"= "#f57f1f",
                 ...
                 "muscle"= "#fcba78","small"= "#aec7e8","spinal"= "#f69796","spleen"= "#cebf8f")
...
time_color <- c("Control" = "#1f77b4","Sham" = "#f57d1f","SCI_0min" = "#92a8af","SCI_30min" = "#d42827","SCI_1h" = "#8458a4",
                ...
                "SCI_7d" = "#fbb978","SCI_14d" = "#b1c7c5","SCI_1m" = "#f69595","SCI_2m" = "#c5afd4","SCI_3m" = '#74A089')
...
Notes:
- The full original R scripts `D.R` and `F.R` are embedded above as R chunks. You can knit this file to an HTML report or extract individual chunks as needed.
