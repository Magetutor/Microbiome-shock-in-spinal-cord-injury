...
Notes:
- The full original R scripts `C.R` and `D.R` are embedded above as R chunks. You can knit this file to an HTML report or extract individual chunks as needed.
